    ...
    <View className='flex-1 bg-gray-900'>
      ...
      <View className='flex-1 bg-white px-8 pt-8'>
        <View className='form space-y-2'>
            ...
            <TextInput className='p-4 bg-gray-100 text-gray-700 rounded-2xl mb-5' secureTextEntry value={password} onChangeText={value=> setPassword(value)} placeholder='Enter Password'/>
